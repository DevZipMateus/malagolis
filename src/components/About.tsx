        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 animate-fade-in">
            <div className="relative">
              <div className="bg-malagoli/20 w-full h-full absolute -left-6 -top-6 rounded-lg"></div>
              <img 
              ...
              <div className="absolute -bottom-8 -right-8 bg-white rounded-lg shadow-lg p-6 z-20 animate-float">
                ...
                <div className="text-3xl font-bold text-gray-900">Paixão por colecionáveis</div>
          ...
          <div className="lg:w-1/2">
            <div className="inline-block bg-malagoli/10 text-malagoli font-medium px-4 py-1.5 rounded-full text-sm mb-4 animate-fade-in">
              Sobre Nós
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start animate-fade-in" style={{ animationDelay: '0.4s' }}>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-1">Gibis e HQs</h4>
              ...
              <div className="flex items-start animate-fade-in" style={{ animationDelay: '0.5s' }}>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-1">Miniaturas Diecast</h4>
              ...
              <div className="flex items-start animate-fade-in" style={{ animationDelay: '0.6s' }}>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-1">Figuras de Ação</h4>

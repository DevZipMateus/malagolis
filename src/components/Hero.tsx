...
const Hero = () => {
  ...
  return (
    <section className="pt-28 md:pt-36 pb-12 md:pb-20 bg-gradient-to-br from-white to-malagoli-light/10 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0 text-center md:text-left">
            <h1 className={`font-bold text-gray-900 leading-tight mb-6 opacity-0 animate-fade-in ${
            ...
            <p className="text-lg text-gray-700 mb-8 max-w-lg mx-auto md:mx-0 opacity-0 animate-fade-in-delay-1">
            ...
            <p className="text-malagoli-dark/80 mt-6 italic text-sm opacity-0 animate-fade-in-delay-3">
